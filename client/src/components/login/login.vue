    ...
    <div class="login-container">
        ...
        <form @submit.prevent="login">
            ...
            <div class="form-header">
                ...
                <h1 class="form-header-text">Log in to your account</h1>
            ...
            <label class="password-label">
                ...
                <div class="password-container">
                    <input :type="visible?'text':'password'" class="password" placeholder="Enter Password" v-model="password" required>

                    <button class="toggle-password-visibility" type="button" @click="toggleVisibility()">
                        
                        <svg v-if="visible" :required="!visible" data-testid="geist-icon" height="16" stroke-linejoin="round"
                        ...
                        <svg v-else :required="visible" data-testid="geist-icon" height="16" stroke-linejoin="round"
                            viewBox="0 0 16 16" width="16">
                            <path fill-rule="evenodd" clip-rule="evenodd"
