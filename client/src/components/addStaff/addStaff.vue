    ...
    <div class="add-staff-container">
        ...
        <form @submit.prevent="addStaff()">
            ...
            <div class="form-header">
                ...
                <h1 class="form-header-text">Add new sales staff</h1>
            ...
            <div class="name-container">
                ...
                <label class="first-name-label">
                    First Name
                    <input type="text" class="first-name-input" placeholder="Enter First Name" v-model="firstName" required>
                </label>

                <label class="last-name-label">
                    Last Name
                    <input type="text" class="last-name-input" placeholder="Enter Last Name" v-model="lastName" required>
                </label>
            ...
            <label class="staff-id-label">
                Staff ID
                <input type="text" class="staff-id-input" placeholder="Enter Staff Id" v-model="staffId" required>
            </label>
            ...
            <label class="password-label">
                ...
                <div class="password-container">
                    <input :type="passwordVisible?'text':'password'" class="password" placeholder="Enter Password" v-model="password" required>

                    <button class="toggle-password-visibility" type="button" @click="togglePasswordVisibility">

                        <svg v-if="passwordVisible" data-testid="geist-icon" height="16" stroke-linejoin="round" viewBox="0 0 16 16"
                            width="16">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <svg  v-else data-testid="geist-icon" height="16" stroke-linejoin="round"
            ...
            <label class="role-label">
                ...
                <div class="role-container">
                    ...
                    <label class="sales-staff-label">
                        <input class="role" type="radio" name="role" value="sales" v-model="role" required>
                        Sales Staff
                    </label>

                    <label class="admin-label">
                        <input class="role" type="radio" name="role" value="admin" v-model="role" required>
                        Admin
                    </label>
            ...
            <button class="add-staff" type="submit">Add Staff</button>
...
<style scoped src="./addStaff.css"></style>

<script setup>

    import {useAddStaff} from "./addStaff.js"
